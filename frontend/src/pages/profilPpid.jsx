    ...
    <Box sx={{ bgcolor: "#f8f9fa", minHeight: "100vh" }}>
      ...
      <Box sx={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("/img/gedungDisnakertrans1.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', pt: { xs: 15, md: 22 }, pb: { xs: 12, md: 18 }, px: 3 }}>
        <Container maxWidth="lg">
          ...
          <Typography variant="h5" sx={{ opacity: 0.9, color: 'white', fontWeight: "normal", maxWidth: "850px", textTransform: "none", fontSize: "1.5rem", lineHeight: 1.6 }}>
            Selamat datang di Portal PPID Pelaksana Dinas Tenaga Kerja dan Transmigrasi Provinsi Jawa Tengah, sumber informasi terpercaya seputar layanan publik, kebijakan, dan inovasi di bidang ketenagakerjaan dan transmigrasi. Temukan berbagai informasi penting, panduan layanan, serta akses mudah untuk mengajukan permohonan informasi publik. Kami berkomitmen untuk memberikan transparansi dan pelayanan terbaik bagi masyarakat Jawa Tengah.
          </Typography>
        </Container>
      </Box>
